...
#define HV_APPLY_PACKS      52  //0x34        Алгоритм поджига. Количество пачек (по 5 импульсов) 3kV импульсов поджига
...
// СМ ВЫШЕ... #define HV_APPLY_PACKS      52  //0x34        Алгоритм поджига. Количество пачек (по 5 импульсов) 3kV импульсов поджига
...
// СМ. ВЫШЕ... #define PH_SH_USAGE         61  //0x3D  "="   Фазовый сдвиг. Включен.
// СМ. ВЫШЕ... #define TD_CALIB_USAGE      62  //0x3E  ">"   использование калибровки термодатчиков
