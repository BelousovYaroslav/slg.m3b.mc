...
// СМ ВЫШЕ... #define HV_APPLY_PACKS      52  //Количество пачек 3kV импульсов поджига

#define AMPL_HOLD_MEAN      53  //Алгоритм стабилизации амплитуды: среднее              0x35  "5"
#define AMPL_HOLD_ROUND     54  //Алгоритм стабилизации амплитуды: круг (период среднего)       0x36  "6"
#define AMPL_HOLD_ACTIVE    55  //Алгоритм стабилизации амплитуды: флаг активной регулировки    0x37 "7"

#define SECONDS_FROM_START  56  //Секундный таймер от момента старта прибора            0x38  "8"

#define PH_SH_CALIB_T       57  //Калибровка фазового сдвига. Точка N. Температура      0x39  "9"
#define PH_SH_CALIB_PH_SH   58  //Калибровка фазового сдвига. Точка N. Соотв. фазовый сдвиг   0x3A  ":"
