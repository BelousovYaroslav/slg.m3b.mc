...
#define DC_SETTINGS_START   66  //0x42  "B"   Настройки использования коэффициента вычета: что брать при старте
                                //                                                         0=брать стартовый dc
                                //                                                         REST=брать из таблицы калибровки
...
#define DECCOEFF_START      75  //0x4B  "K"   Стартовый коэффициент вычета
#define DC_SETTINGS_RECALC  76  //0x4C  "L"   Настройки использования коэффициента вычета: как переопределять в процессе работы
                                //                                                         0=перевычисление на лету
                                //                                                         1=перевычисление ступенчатая
                                //                                                         2=калибровка сглаженная
                                //                                                         3=ручной режим
#define DC_SETTINGS_RECALC_PERIOD 77  //0x4D  "M"   Настройки использования коэффициента вычета: период переопределения Квычета в секундах
...
#define AMPLANG_DUS         7   //0x07        амплитуда получаемая с ДУСа
#define RULA                8   //0x08        напряжение RULA
#define DECCOEFF_CURRENT    13  //0x0D        Калибровка коэффициента вычета. Текущее значение коэффициент вычета
#define UTD1                0   //0x00        термодатчик 1
#define UTD2                1   //0x01        термодатчик 2
#define UTD3                2   //0x02        термодатчик 3
#define I1                  3   //0x03        разрядный ток i1
...
#define CONTROL_AA          16  //0x10        Контрольный сигнал раскачки AmplAng
#define START_RULA          74  //0x4A  "J"   Стартовое RULA
#define DECCOEFF_START      75  //0x4B        Стартовый коэффициент вычета
...
#define DC_SETTINGS_START   66  //0x42  "B"   Настройки использования коэффициента вычета: что брать при старте
                                //                                                         0=брать стартовый dc
                                //                                                         REST=брать из таблицы калибровки
#define DECCOEFF_CURRENT    13  //0x0D        ТЕКУЩЕЕ значение коэффициент вычета
#define DECCOEFF_START      75  //0x4B  "K"   СТАРТОВЫЙ коэффициент вычета
#define DC_SETTINGS_RECALC  76  //0x4C  "L"   Настройки использования коэффициента вычета: как переопределять в процессе работы
                                //                                                         0=перевычисление на лету
                                //                                                         1=перевычисление ступенчатая
                                //                                                         2=калибровка сглаженная
                                //                                                         3=ручной режим
#define DC_SETTINGS_RECALC_PERIOD
                            77  //0x4D  "M"   Настройки использования коэффициента вычета: период переопределения Квычета в секундах
